...
public interface IMethodDeclaration extends IDeclaration {
	...
	Specificity computeSpecificity(Context context, IParameter argument, Argument assignment, boolean useInstance, boolean allowDerived);
	...
	void compileAssignments(Context context, MethodInfo method, Flags flags, ArgumentList assignments);
	@Override
