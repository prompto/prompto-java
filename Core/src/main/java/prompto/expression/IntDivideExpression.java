...
public class IntDivideExpression extends CodeSection implements IExpression {
	...
	public IType check(Context context) {
		...
		return lt.checkIntDivide(context, rt, this);
	}
	...
	public ResultInfo compile(Context context, MethodInfo method, Flags flags) {
		...
		if(divider==null) {
			...
			throw new SyntaxError("Cannot idivide " + lval.getType().getTypeName() + " by " + right.check(context).getFamilyInfo(context));
		}
	...
	public void declare(Transpiler transpiler) {
	    ...
	    lt.declareIntDivide(transpiler, rt, this.left, this.right, this);
	}
