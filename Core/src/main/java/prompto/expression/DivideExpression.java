...
public class DivideExpression extends CodeSection implements IExpression {
	...
	public IType check(Context context) {
		...
		return lt.checkDivide(context, rt, this);
	}
	...
	public ResultInfo compile(Context context, MethodInfo method, Flags flags) {
		...
		if(divider==null) {
			...
			throw new SyntaxError("Cannot divide " + lval.getType().getTypeName() + " by " + right.check(context).getFamilyInfo(context));
		}
	...
	public void declare(Transpiler transpiler) {
	    ...
	    lt.declareDivide(transpiler, rt, this.left, this.right, this);
	}
