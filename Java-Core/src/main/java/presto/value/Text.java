...
public class Text extends BaseValue implements Comparable<Text>, ICollection<Character>, ISliceable<Character>, IMultiplyable {
	...
	public boolean hasItem(Context context, IValue value) throws PrestoError {
	...
	public Character getItem(Context context, IValue index) throws PrestoError {
		try {
	...
	public ISliceable<Character> slice(Integer fi, Integer li) throws PrestoError {
