...
public class OPrestoBuilder extends OParserBaseListener {
	...
	public void exitAddExpression(AddExpressionContext ctx) {
		...
		IExpression exp = ctx.op.getType()==OParser.PLUS ? new AddExpression(left, right) : new SubtractExpression(left, right);
