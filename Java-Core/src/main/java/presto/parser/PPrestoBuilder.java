...
public class PPrestoBuilder extends PParserBaseListener {
	...
	public void exitAddExpression(AddExpressionContext ctx) {
		...
		IExpression exp = ctx.op.getType()==PParser.PLUS ? new AddExpression(left, right) : new SubtractExpression(left, right);
