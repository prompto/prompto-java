...
public class SPromptoBuilder extends SParserBaseListener {

	ParseTreeProperty<Object> nodeValues = new ParseTreeProperty<Object>();
	TokenStream input;
	String path = "";

	public SPromptoBuilder(SCleverParser parser) {
	...
	public void exitAddExpression(AddExpressionContext ctx) {
		...
		IExpression exp = ctx.op.getType()==SParser.PLUS ? new PlusExpression(left, right) : new SubtractExpression(left, right);
